...
const UpdateSubCateImage = ({
  ...
  const { updateImgLoading, updateImgSuccess, updateImgError } =updateSubCateImgState;
  ...
  const updateImage = () => {
    ...
    dispatch(updateSubCateImage(upImageId, base64Data));
  };
...
export default UpdateSubCateImage;
